...
{
    /// <inheritdoc />
    public partial class AddIdentityAndRefreshSessions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RefreshSessions_AbsoluteExpiry", "[AbsoluteExpiresAtUtc] >= [ExpiresAtUtc]");
                    table.CheckConstraint("CK_RefreshSessions_ExpiresAfterCreation", "[ExpiresAtUtc] > [CreatedAtUtc]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshSessions_UserId_RevokedAtUtc_ExpiresAtUtc",
                table: "RefreshSessions",
